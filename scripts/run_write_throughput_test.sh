...
function gen_yaml() {
    local kv=$1
    local flash=$2
    rm -rf write_throughput_test/config/write_thoughput_test_tidb_${kv}_${flash}.yaml
    cat write_throughput_test/config/write_thoughput_test_tidb.yaml > write_throughput_test/config/write_thoughput_test_tidb_${kv}_${flash}.yaml
    cat write_throughput_test/config/tikv.yaml >> write_throughput_test/config/write_thoughput_test_tidb_${kv}_${flash}.yaml
    echo "        replica: $kv" >> write_throughput_test/config/write_thoughput_test_tidb_${kv}_${flash}.yaml
    cat write_throughput_test/config/tiflash.yaml >> write_throughput_test/config/write_thoughput_test_tidb_${kv}_${flash}.yaml
    echo "        replica: $flash" >> write_throughput_test/config/write_thoughput_test_tidb_${kv}_${flash}.yaml
}
...
do
  ...
  #:    echo ${kv}_${flash}
    ...
    tcctl testbed create -f write_throughput_test/config/write_throughput_test/config/write_thoughput_test_tidb_${kv}_${flash}.yaml -r http://rms.pingcap.net:30007
